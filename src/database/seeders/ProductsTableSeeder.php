...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $fruitId = DB::table('products')->insertGetId([
            'name' => 'キウイ',
            'price' => 800,
            'image' => 'img/kiwi.png',
        ...
        DB::table('product_season')->insert([
            ['product_id' => $fruitId, 'season_id' => 3, 'created_at' => now(), 'updated_at' => now()],
            ['product_id' => $fruitId, 'season_id' => 4, 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $fruitId, 'season_id' => 1, 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('product_season')->insert([
            ['product_id' => $fruitId, 'season_id' => 2, 'created_at' => now(), 'updated_at' => now()],
        ]);
